...
## Demo page
https://squarespace-cc.surge.sh (change name in package.json)
...
`pug`              | compile [pug](http://pug-js.com/) templates (not used)
`javascript`       | combines vendor files and custom .js code into separate files
`sprite:svg`       | create svg symbol sprites (removed)
`sprite:png`       | create png sprites (removed)
